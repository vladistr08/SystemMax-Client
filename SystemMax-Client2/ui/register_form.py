...
"background-color: #070F2B;")
        ...
        self.usernameLineEdit.setGeometry(QRect(270, 120, 261, 31))
...
"background-color: #070F2B;")
        ...
        self.label_2.setGeometry(QRect(160, 130, 101, 16))
        ...
        self.serverStatusLabel.setGeometry(QRect(10, 540, 171, 16))
